...
public class MaterialIntroView1 extends RelativeLayout {
    ...
    public MaterialIntroView1(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context);
    }

    public MaterialIntroView1(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        init(context);
    }

    @TargetApi(Build.VERSION_CODES.LOLLIPOP)
    public MaterialIntroView1(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
    ...
    private void init(Context context) {
        ...
        View layoutInfo = LayoutInflater.from(getContext()).inflate(R.layout.material_intro_card1, null);
        ...
        getViewTreeObserver().addOnGlobalLayoutListener(new ViewTreeObserver.OnGlobalLayoutListener() {
            ...
            public void onGlobalLayout() {
                ...
                if (targetShape != null && targetShape.getPoint().y != 0 && !isLayoutCompleted) {
                    ...
                    // if(isDotViewEnabled)
                        // setDotViewLayout();
                    removeOnGlobalLayoutListener(MaterialIntroView1.this, this);
                }
            }
        });
        ...
        handler.postDelayed(new Runnable() {
            ...
            public void run() {
                if (isFadeAnimationEnabled)
                    AnimationFactory.animateFadeIn(MaterialIntroView1.this, fadeAnimationDuration, new AnimationListener.OnAnimationStartListener() {
                        @Override
    ...
    private void addNextBtn() {
        ...
        btn.setText("----------------------");
        btn.setId(R.id.show_case_next);

        // 定义一个RelativeLayout组件
        LayoutParams lp = new LayoutParams(ViewGroup.LayoutParams.WRAP_CONTENT, ViewGroup.LayoutParams.WRAP_CONTENT);
        lp.addRule(RelativeLayout.BELOW, R.id.info_layout);
    ...
    public static class Builder {
        ...
        private MaterialIntroView1 materialIntroView;
        ...
        public Builder(Activity activity) {
            ...
            materialIntroView = new MaterialIntroView1(activity);
        }
        ...
        public MaterialIntroView1 build() {
        ...
        public MaterialIntroView1 show() {
            build().show(activity);
            return materialIntroView;
        }
